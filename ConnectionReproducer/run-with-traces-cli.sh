...
mvn exec:exec -Dexec.executable=java -Dexec.args="-Xmx512m -Dorg.xnio.ssl.TRACE_SSL=true -XX:MetaspaceSize=128m -Djava.util.logging.manager=org.jboss.logmanager.LogManager -Dlogging.configuration=file:./logging$1.properties -classpath %classpath:$LOGGING_MODULES com.mycompany.testconnect.MainCLI"
